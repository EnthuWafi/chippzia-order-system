    ...
    echo "<div class='navbar navbar-expand-lg shadow bg-white sticky-top'>
        <div class='container-fluid w-100'>
            ...
            <div class='navbar-nav ms-auto order-las'>
                <form class='d-flex' role='search' action='{$base_url}account/search.php'>
...
function admin_header_bar($pageName){
    ...
    echo "<div class='navbar navbar-expand-lg shadow navbar-white bg-white sticky-top'>
        <div class='container-fluid w-100'>
            ...
            <div class='navbar-nav ms-auto order-las'>
                <form class='d-flex' role='search' action='{$base_url}admin/search.php'>
                    <input class='form-control me-2' type='search' name='q' placeholder='Search' aria-label='Search'>
          ...
          <div class='col-md-4 col-sm-6'>
            <div class='Shipping d-flex'>
              ...
              <div class='card-wrap ps-2'>
                <img src='{$base_url}assets/images/dhl.png' alt='dhl'>
              </div>
            </div>
          </div>
          <div class='col-md-4 col-sm-6'>
            <div class='payment-method d-flex'>
              <p>Payment options:</p>
              <div class='card-wrap ps-2'>
                <img src='{$base_url}assets/images/visa.jpg' alt='visa'>
                <img src='{$base_url}assets/images/mastercard.jpg' alt='mastercard'>
                <img src='{$base_url}assets/images/paypal.jpg' alt='paypal'>
              </div>
            </div>
          </div>
          <div class='col-md-4 col-sm-6'>
